...
- **`/bus-git-watch [owner/repo]`** — vigia as **issues de um repositório GitHub** e converte **cada evento** (issue nova, comentário, fechamento) num **handoff** pro especialista dono do assunto. Um monitor de fundo só acorda a sessão quando algo muda. É o par natural do BUS: **o BUS move o trabalho, o GitHub guarda backlog e histórico** — o que sobrevive ao `/clear`, ao restart e à compactação. Rode na sessão do **controlador (prio 0)**.
